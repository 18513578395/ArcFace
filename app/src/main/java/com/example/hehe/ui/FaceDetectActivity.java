...
import com.example.hehe.camera.CameraManager;
import com.example.hehe.camera.CameraParamet;
import com.example.hehe.entity.CompareFaceResult;
import com.example.hehe.entity.DrawFaceInfoEntity;
import com.example.hehe.entity.FaceInfoEntity;
import com.example.hehe.face.ArcFaceEngine;
import com.example.hehe.face.ArcFaceParameter;
import com.example.hehe.face.FaceDetectInfo;
import com.example.hehe.face.OnEngineStateListen;
import com.example.hehe.face.OnFaceDetectResult;
import com.example.hehe.utils.FaceConvertUtils;
import com.example.hehe.widget.FaceRectView;
    ...
    public void quertFaceForDb(List<FaceDetectInfo> faceDetectInfos){
       ...
       mFaceRectView.drawFaceRect(mDrawFaceInfoEntityList);
        ...
        if(mRegisterCompareFaces.size()>0){
            ...
            Toast.makeText(FaceDetectActivity.this,"已注册",Toast.LENGTH_SHORT).show();
        }
        if(mNotRegisterCompareFaces.size() >0){
            Toast.makeText(FaceDetectActivity.this,"请去注册",Toast.LENGTH_SHORT).show();
        }
